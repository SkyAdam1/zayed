...
urlpatterns = [
    ...
    path('application_detail/<int:id>', views.ApplicationsDetailView.as_view(), name='applications_detail_url'),
    ...
    path('reports/', views.ApplicationsReportingView.as_view(), name='applications_reporting_url'),
    path('create_report/', views.ApplicationReportView.as_view(), name='applications_add_report_url'),
    path('report_detail/<int:id>', views.ReportsDetail.as_view(), name='reports_detail_url'),
